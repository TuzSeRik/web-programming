    ...
    render() {
        return(
            <table className="input-table">
                <tr>
                    <td>
                        <input type="checkbox" value="0.5" name="r" id="r_0.5"
                ...
                <tr>
                    <td>
                        <input type="checkbox" value="3.5" name="r" id="r_3.5"
                               onChange={(e) => this.props.dispatch({type:"MAIN_SET_R",value: e.target.value})}
                               checked={this.props.r === 3.5} />
                        <label htmlFor="r_3.5">3.5</label>
                    </td>
                    <td>
                        <input type="checkbox" value="4" name="r" id="r_4"
                               onChange={(e) => this.props.dispatch({type:"MAIN_SET_R",value: e.target.value})}
                               checked={this.props.r === 4} />
                        <label htmlFor="r_4">4</label>
                    </td>
                    <td>
                        <input type="checkbox" value="4.5" name="r" id="r_4.5"
                               onChange={(e) => this.props.dispatch({type:"MAIN_SET_R",value: e.target.value})}
