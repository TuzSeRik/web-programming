            ...
            <main className="container">
                <div className="login-window">
                    <div className="login">
                        ...
                        <label className="login-label">Имя пользователя
                    ...
                    <div className="registration-suggest">
                        <h4 className="question-text">Новый пользователь?</h4>
                        <div className={!this.props.error? 'hidden' : 'warn'}>
                            <span className="error">Неверное имя пользователя или пароль</span>
                        </div>
                        <button className="login-button" onClick={this.redirectToRegister}>Зарегестрироваться</button>
                    </div>
                </div>
            </main>
        )
